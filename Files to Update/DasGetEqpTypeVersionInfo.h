...
const Vi_Version DasGetEqpType_Version_Prev ( "DasGetEqpType.Prev", "2021/12/05", "000", "01", "RELS_DASGETEQPTYPE_000-01", "", "hp");
const Vi_Version DasGetEqpType_Version( "DasGetEqpType", "2023/09/04", "002", "01", "RELS_DASGETEQPTYPE_002-01", "", "hp");
