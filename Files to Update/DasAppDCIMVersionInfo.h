...
//const Vi_Version DasAppDCIM_Version_Prev ( "DasAppDCIM.Prev", "2023/08/30", "004", "01", "RELS_DASAPPDCIM_004-01", "", "dxc");
//const Vi_Version DasAppDCIM_Version_Prev ( "DasAppDCIM.Prev", "2023/08/30", "006", "01", "RELS_DASAPPDCIM_006-01", "", "dxc");
const Vi_Version DasAppDCIM_Version_Prev ( "DasAppDCIM.Prev", "2023/08/30", "009", "01", "RELS_DASAPPDCIM_009-01", "", "dxc");
const Vi_Version DasAppDCIM_Version ( "DasAppDCIM ", "2023/08/30", "001", "01", "RELS_DASAPPDCIM_010-01", "", "dxc");
