        ...
        else if (option == 1 || option == 2)
        {
            ...
            if (option == 1)
            {
                ...
                std::vector<std::string> headerFiles = {
                    "DasAppDCIMVersionInfo",
                    "DasEventFilterVersionInfo",
                    "DasExdpLoadDataVersionInfo",
                    "DasExportParametersVersionInfo",
                    "DasExportSEMIObjectsVersionInfo",
                    "DasGetEqpTypeVersionInfo",
                    "DasMaskApplyVersionInfo",
                    "DasUipLoadDataVersionInfo"
                };
